...
\pandocbounded{\includegraphics[keepaspectratio]{images/git-ignore-env.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/node_check_1.1.2_check_if_nodes_are_operating_properly.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/node_check_1.1.3_battery_vs_time_all_nodes.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/node_check_1.1.3_node_specific_battery_solar_normal.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/node_check_1.1.3_node_specific_battery_solar_bad.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/node_check_1.3_node_locations.png}}
\#\#\# Check Time Offset
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/node_check_1.4_time_offset.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/node_calibration_2.4_node_loc_plot.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/node_calibration_2.4_node_map.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/node_calibration_2.5_sidekick_calibration.png}}
\caption{Node location plot}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/node_calibration_3.1_calculate_rssi_vs_distance.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/node_calibration_3.1_fit_relationship.png}}
\caption{RSSI vs.~Distance}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/presence_absence_detected_tags_histogram.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/presence_absence_detections_heat_bin.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/presence_absence_detections_over_time_specific_tag.png}}
\caption{Heat-plot of tag detections over time}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/activity_level_rssi_vs_time_by_node.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/activity_level_activity_vs_time_by_node.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/presence_absence_2d_histogram_activity_vs_time.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/activity_level_average_activity_vs_time.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/activity_level_average_activity_per_hour_vs_time.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/habitat_use_node_loc_plot.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/habitat_use_node_map.png}}
\caption{Node location map}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/habitat_use_grid_map.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/habitat_use_track_map.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/habitat_use_location_density_map.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/multilateration_rss_vs_distance.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/multilateration_predicted_line.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/multilateration_rings_map.png}}
\caption{Ring Map}
\end{figure}
