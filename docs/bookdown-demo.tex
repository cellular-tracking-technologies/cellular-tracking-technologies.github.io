...
\subsubsection{Checking Nodes are operating}\label{checking-nodes-are-operating}
...
\FunctionTok{ggplot}\NormalTok{(node\_record\_counts,}
       \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \FunctionTok{factor}\NormalTok{(node\_id,}
\NormalTok{                      node\_record\_counts}\SpecialCharTok{$}\NormalTok{node\_id),}
...
\NormalTok{sidekick\_file\_path }\OtherTok{\textless{}{-}} \StringTok{"./data/Meadows V2/sidekick/calibration\_2023\_8\_3\_t2.csv"}
