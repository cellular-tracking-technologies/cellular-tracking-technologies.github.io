...
\hypersetup{
  ...
  pdfauthor={Jessica Gorzo, Sean Burcher, Meelyn Pandit},
  hidelinks,
...
\addcontentsline{toc}{chapter}{AOS2024 - `celltracktech' Workshop}
...
\section{Download the ``celltracktech'' package using renv}\label{download-the-celltracktech-package-using-renv}

Copy and paste the following command into your R console. This command will install the latest version of the celltracktech package from GitHub.
...
To access the CTT Application Programming Interface (API) (i.e.~the program to download your data from the CTT servers), you will need an API token. You can request one \href{https://celltracktech.com/pages/csd-radio-api-key-request}{here}. Add ``Meadows V2'' in the comments section.
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/git-ignore-env.png}}
...
If you want to download just your data files (in .csv.gz format), and not use a database, you can run the following script:
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/node_check_1.1.2_check_if_nodes_are_operating_properly.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/node_check_1.1.3_battery_vs_time_all_nodes.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/node_check_1.1.3_node_specific_battery_solar_normal.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/node_check_1.1.3_node_specific_battery_solar_bad.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/node_check_1.3_node_locations.png}}
\#\#\# Check Time Offset
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/node_check_1.4_time_offset.png}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0566}}
  >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0566}}
  >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1321}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/node_calibration_2.4_node_loc_plot.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/node_calibration_2.4_node_map.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/node_calibration_2.5_sidekick_calibration.png}}
\caption{Node location plot}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/node_calibration_3.1_calculate_rssi_vs_distance.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/node_calibration_3.1_fit_relationship.png}}
\caption{RSSI vs.~Distance}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/presence_absence_detected_tags_histogram.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/presence_absence_detections_heat_bin.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/presence_absence_detections_over_time_specific_tag.png}}
\caption{Heat-plot of tag detections over time}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/activity_level_rssi_vs_time_by_node.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/activity_level_activity_vs_time_by_node.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/presence_absence_2d_histogram_activity_vs_time.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/activity_level_average_activity_vs_time.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/activity_level_average_activity_per_hour_vs_time.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/habitat_use_node_loc_plot.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/habitat_use_node_map.png}}
\caption{Node location map}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/habitat_use_grid_map.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/habitat_use_track_map.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/habitat_use_location_density_map.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/multilateration_rss_vs_distance.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/multilateration_predicted_line.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/multilateration_rings_map.png}}
\caption{Ring Map}
\end{figure}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{no.filters }\OtherTok{\textless{}{-}} \FunctionTok{trilateration\_testdata\_nofilter}\NormalTok{(combined\_data)}
...
\NormalTok{RSS.filters }\OtherTok{\textless{}{-}} \FunctionTok{trilateration\_testdata\_rss\_filter}\NormalTok{(combined\_data, RSS.FILTER)}
...
\CommentTok{\#Dist.filters \textless{}{-} trilateration\_testdata\_distance\_filter(combined\_data, DIST.FILTER)}
...
Base URL: \url{https://api.internetofwildlife.com}
Protocol: HTTPS
Method: All endpoints use POST
Encoding: JSON
Timeout: 60 seconds per request

All endpoints require an API token passed in the JSON request body as \texttt{token}. The token is loaded from a \texttt{.env} file via \texttt{dotenv} and accessed with \texttt{Sys.getenv("MY\_TOKEN")}.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(dotenv)}
\FunctionTok{load\_dot\_env}\NormalTok{()}
\NormalTok{my\_token }\OtherTok{\textless{}{-}} \FunctionTok{Sys.getenv}\NormalTok{(}\StringTok{"MY\_TOKEN"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\section{Typical Workflow}\label{typical-workflow}
...
The \texttt{get\_my\_data()} function orchestrates this entire workflow in a single call.

\section{POST Wrapper}\label{post-wrapper}

All endpoints (except direct calls in \texttt{get\_my\_projects} and \texttt{project\_list}) go through the \texttt{post()} function in \texttt{R/post.R}:

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{post}\NormalTok{(endpoint, }\AttributeTok{payload =} \ConstantTok{NULL}\NormalTok{, }\AttributeTok{show\_progress =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Automatically injects \texttt{token\ =\ my\_token} into every request
\item
  60-second timeout on all requests
\item
  Detects HTTP 503 and emits a warning suggesting narrower date ranges or pagination
\item
  Calls \texttt{httr::stop\_for\_status()} to raise on other HTTP errors
\item
  Optional progress bar via \texttt{httr::progress()}
\end{itemize}

\section{\texorpdfstring{List Projects {Projects}}{List Projects Projects}}\label{list-projects-projects}
...
\subsection{curl Example}\label{curl-example}

\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{curl} \AttributeTok{{-}X}\NormalTok{ POST https://api.internetofwildlife.com/station/api/projects }\DataTypeTok{\textbackslash{}}
  \AttributeTok{{-}H} \StringTok{"Content{-}Type: application/json"} \DataTypeTok{\textbackslash{}}
  \AttributeTok{{-}d} \StringTok{\textquotesingle{}\{"token": "YOUR\_API\_TOKEN"\}\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{\{}
  \DataTypeTok{"projects"}\FunctionTok{:} \OtherTok{[}
    \FunctionTok{\{}
      \DataTypeTok{"id"}\FunctionTok{:} \StringTok{"abc123"}\FunctionTok{,}
      \DataTypeTok{"name"}\FunctionTok{:} \StringTok{"My Wildlife Project"}
    \FunctionTok{\}}\OtherTok{,}
    \FunctionTok{\{}
      \DataTypeTok{"id"}\FunctionTok{:} \StringTok{"def456"}\FunctionTok{,}
      \DataTypeTok{"name"}\FunctionTok{:} \StringTok{"Raptor Tracking Study"}
    \FunctionTok{\}}
  \OtherTok{]}
\FunctionTok{\}}
\end{Highlighting}
...
httr::stop\_for\_status() raises: ``Unauthorized (HTTP 401)''

{503}

Server overloaded or temporarily down

Warning: ``Server query timeout --- try narrowing your date range or using pagination'', then execution stops

{Timeout}

Network issue or server unreachable

R error: ``Timeout was reached'' after 60 seconds

{Empty token}

.env file missing or MY\_TOKEN not set

API returns auth error; Sys.getenv(``MY\_TOKEN'') silently returns ``\,`` if unset
...
\subsection{R Package Functions}\label{r-package-functions}

\begin{itemize}
\tightlist
\item
  get\_my\_projects() in R/get\_my\_projects.R --- returns a character vector of project names
\item
  project\_list() in R/project\_list.R --- returns filtered project list with optional name matching
\end{itemize}

\section{\texorpdfstring{List Stations {Stations}}{List Stations Stations}}\label{list-stations-stations}
...
Project identifier obtained from the List Projects endpoint

\subsection{curl Example}\label{curl-example-1}

\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{curl} \AttributeTok{{-}X}\NormalTok{ POST https://api.internetofwildlife.com/station/api/stations/ }\DataTypeTok{\textbackslash{}}
  \AttributeTok{{-}H} \StringTok{"Content{-}Type: application/json"} \DataTypeTok{\textbackslash{}}
  \AttributeTok{{-}d} \StringTok{\textquotesingle{}\{"token": "YOUR\_API\_TOKEN", "project{-}id": "YOUR\_PROJECT\_ID"\}\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{\{}
  \DataTypeTok{"stations"}\FunctionTok{:} \OtherTok{[}
    \FunctionTok{\{}
      \DataTypeTok{"station"}\FunctionTok{:} \FunctionTok{\{}
        \DataTypeTok{"id"}\FunctionTok{:} \StringTok{"STATION{-}001"}
      \FunctionTok{\},}
      \DataTypeTok{"deploy{-}at"}\FunctionTok{:} \StringTok{"2024{-}01{-}15T00:00:00.000Z"}\FunctionTok{,}
      \DataTypeTok{"end{-}at"}\FunctionTok{:} \StringTok{"2024{-}06{-}01T00:00:00.000Z"}
    \FunctionTok{\}}\OtherTok{,}
    \FunctionTok{\{}
      \DataTypeTok{"station"}\FunctionTok{:} \FunctionTok{\{}
        \DataTypeTok{"id"}\FunctionTok{:} \StringTok{"STATION{-}002"}
      \FunctionTok{\},}
      \DataTypeTok{"deploy{-}at"}\FunctionTok{:} \StringTok{"2024{-}03{-}01T00:00:00.000Z"}\FunctionTok{,}
      \DataTypeTok{"end{-}at"}\FunctionTok{:} \KeywordTok{null}
    \FunctionTok{\}}
  \OtherTok{]}
\FunctionTok{\}}
\end{Highlighting}
...
\tightlist
\item
  \textbf{\texttt{station.id}} --- unique station identifier
\item
  \textbf{\texttt{deploy-at}} --- ISO 8601 deployment start timestamp
\item
  \textbf{\texttt{end-at}} --- ISO 8601 deployment end timestamp (null for active stations)
\end{itemize}
...
httr::stop\_for\_status() stops execution with an HTTP error
...
Project exists but has no deployed stations

Response returns ``stations'': {[}{]}; downstream code in get\_data() skips processing

\subsection{R Package Functions}\label{r-package-functions-1}

\begin{itemize}
\tightlist
\item
  get\_stations() in R/get\_stations.R
\item
  get\_data() in R/get\_data.R --- iterates stations to build file lists
\end{itemize}

\section{\texorpdfstring{List Station Files {Files}}{List Station Files Files}}\label{list-station-files-files}

{POST}
{/station/api/file-list}

Retrieves metadata for data files available from a specific station, with optional date range and file type filtering. Supports pagination via \texttt{limit} and \texttt{offset}.
...
Station identifier obtained from the List Stations endpoint
...
End date for file search. Defaults to today if omitted.
...
Maximum number of files to return (for pagination)
...
\subsection{curl Examples}\label{curl-examples}

\textbf{Basic request (required fields only):}

\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{curl} \AttributeTok{{-}X}\NormalTok{ POST https://api.internetofwildlife.com/station/api/file{-}list }\DataTypeTok{\textbackslash{}}
  \AttributeTok{{-}H} \StringTok{"Content{-}Type: application/json"} \DataTypeTok{\textbackslash{}}
  \AttributeTok{{-}d} \StringTok{\textquotesingle{}\{"token": "YOUR\_API\_TOKEN", "station{-}id": "YOUR\_STATION\_ID", "begin": "2024{-}01{-}01"\}\textquotesingle{}}
\end{Highlighting}
\end{Shaded}

\textbf{Full request with all options:}
...
\StringTok{    "token": "YOUR\_API\_TOKEN",}
\StringTok{    "station{-}id": "YOUR\_STATION\_ID",}
\StringTok{    "begin": "2024{-}01{-}01",}
\StringTok{    "end": "2024{-}02{-}01",}
\StringTok{    "file{-}types": ["data", "gps"],}
\StringTok{    "limit": 100,}
\StringTok{    "offset": 0}
...
\FunctionTok{\{}
  \DataTypeTok{"files"}\FunctionTok{:} \OtherTok{[}
    \FunctionTok{\{}
      \DataTypeTok{"id"}\FunctionTok{:} \StringTok{"file{-}789"}\FunctionTok{,}
      \DataTypeTok{"name"}\FunctionTok{:} \StringTok{"CTT{-}STATION001{-}data.csv.gz"}
    \FunctionTok{\}}\OtherTok{,}
    \FunctionTok{\{}
      \DataTypeTok{"id"}\FunctionTok{:} \StringTok{"file{-}790"}\FunctionTok{,}
      \DataTypeTok{"name"}\FunctionTok{:} \StringTok{"CTT{-}STATION001{-}gps.csv.gz"}
    \FunctionTok{\}}
  \OtherTok{]}
\FunctionTok{\}}
\end{Highlighting}
...
Note: Large date ranges may cause 503 server timeouts. Use get\_station\_file\_list\_paginated() to handle this automatically. The paginated version retries failed chunks up to max\_retries times (default 3) with exponential backoff (2s, 4s, 6s).

\subsection{Errors}\label{errors-2}
...
Date range too large; server times out

Warning: ``Server query timeout --- try narrowing your date range or using pagination''. The paginated wrapper catches this and retries: ``Request timed out, retrying (attempt X of Y)\ldots{}''

{Timeout}

Network issue or server unreachable

R error: ``Timeout was reached'' after 60 seconds. Paginated wrapper retries up to max\_retries times with exponential backoff.

{Invalid type}

A value in file-types is not one of the 8 valid types

Warning: ``WARNING: invalid file type specified - ignoring: \textless type\textgreater{}''. Invalid types are dropped; request proceeds with valid types only.
...
Station has no files for the given date range

get\_data() prints ``no files found from API'' and returns an empty list

{Max retries}

Paginated wrapper exhausts all retry attempts on a chunk

The original error is re-thrown via stop(e), halting execution

\subsection{R Package Functions}\label{r-package-functions-2}

\begin{itemize}
\tightlist
\item
  get\_station\_file\_list() in R/get\_station\_file\_list.R --- single request with optional pagination params
\item
  get\_station\_file\_list\_paginated() in R/get\_station\_file\_list\_paginated.R --- automatic date-chunked pagination with retry logic
\end{itemize}

\section{\texorpdfstring{Download File {Files}}{Download File Files}}\label{download-file-files}
...
File identifier obtained from the List Station Files endpoint
...
\subsection{curl Examples}\label{curl-examples-1}

\textbf{Basic download:}

\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{curl} \AttributeTok{{-}X}\NormalTok{ POST https://api.internetofwildlife.com/station/api/download{-}file/ }\DataTypeTok{\textbackslash{}}
  \AttributeTok{{-}H} \StringTok{"Content{-}Type: application/json"} \DataTypeTok{\textbackslash{}}
  \AttributeTok{{-}d} \StringTok{\textquotesingle{}\{"token": "YOUR\_API\_TOKEN", "file{-}id": "YOUR\_FILE\_ID"\}\textquotesingle{}}
\end{Highlighting}
\end{Shaded}

\textbf{With bypass encoding (fallback on error):}

\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{curl} \AttributeTok{{-}X}\NormalTok{ POST https://api.internetofwildlife.com/station/api/download{-}file/ }\DataTypeTok{\textbackslash{}}
  \AttributeTok{{-}H} \StringTok{"Content{-}Type: application/json"} \DataTypeTok{\textbackslash{}}
  \AttributeTok{{-}d} \StringTok{\textquotesingle{}\{"token": "YOUR\_API\_TOKEN", "file{-}id": "YOUR\_FILE\_ID", "bypass{-}encoding": "plain"\}\textquotesingle{}}
\end{Highlighting}
\end{Shaded}

\subsection{Response}\label{response-3}

\textbf{200 OK} --- Raw file content (CSV text, UTF-8 encoded)
...
In batch downloads via \texttt{get\_data()}, each file result is tracked in a dataframe. The final summary prints: \texttt{"Download\ complete:\ X\ succeeded,\ Y\ failed\ out\ of\ Z\ files"}

\subsection{Errors}\label{errors-3}
...
File content has encoding issues the server can't handle

download\_files() prints ``Here's the original error message:'' followed by the error detail, then automatically retries with bypass-encoding = ``plain''

{500 (retry)}

File is corrupted or unrecoverable (retry also fails)

Error propagates up; get\_data() catches it per-file and records status = ``failed'' in results dataframe
...
Any error during a single file download within get\_data()
...
\subsection{R Package Functions}\label{r-package-functions-3}

\begin{itemize}
\tightlist
\item
  download\_files() in R/download\_files.R
\item
  Called from get\_data() in R/get\_data.R for each file in the download queue
\end{itemize}
