...
\textbf{Usage}\\
load\_data(directory\_name=NULL, starttime=NULL, endtime=NULL, tags=NULL)
...
\textbf{Usage}\\
node\_channel\_plots(health, freq, ids, lat=NULL, lon=NULL)
...
\textbf{Usage}\\
node\_plots(health, nodes, freq, lat = NULL, lon = NULL)
...
\tightlist
\item
  health: the 2nd dataframe output by the load\_data() function\\
\item
  nodes: list of nodes\\
\item
  freq: the time interval for which you want variables to be summarized\\
...
\textbf{Usage}\\
export\_node\_channel\_plots(plotlist=NULL,health,freq=``1 hour'',out\_path=getwd(),whichplots = c(3,2,1))
...
\textbf{Description}\\
NOTE: THIS ONLY WORKS FOR V2\\
same as above; index for the plots can be chosen from the list under the node\_plots() description\\
\textbf{Usage}\\
export\_node\_plots(plotlist = NULL, health,freq,out\_path=getwd(), x=2, y=3, z=1)
