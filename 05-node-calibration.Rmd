...
### 5.1.1 Load libraries

```{r}
library(celltracktech)
library(dotenv)
```
### 5.1.2 Load sidekick data file
```{r}
...
#### 5.1.2.1 IF YOU DO NOT HAVE A SIDEKICK DATA FILE:
...
### 5.1.3 Load environmental variables into RStudio
```{r}
# load env file into environment
load_dot_env(file='.env')
```

### 5.1.4 Load functions
```{r}
# DEFS
